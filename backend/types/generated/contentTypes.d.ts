...
export interface ApiAddOnAddOn extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Upsell add-on services (Pet Hair, Headlight Restoration, etc.)';
    displayName: 'Add On';
    pluralName: 'add-ons';
    singularName: 'add-on';
  };
  ...
  attributes: {
    applicableServices: Schema.Attribute.Relation<
      'manyToMany',
      'api::service.service'
    >;
    ...
    durationMinutes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service bookings connecting customers, contractors, and services';
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    >;
    contractorEarnings: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    timeWindow: Schema.Attribute.Enumeration<
...
export interface ApiContractorAvailabilityContractorAvailability
  extends Struct.CollectionTypeSchema {
  collectionName: 'contractor_availabilities';
  info: {
    description: 'Daily availability records for contractors';
    displayName: 'Contractor Availability';
    pluralName: 'contractor-availabilities';
    singularName: 'contractor-availability';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contractor-availability.contractor-availability'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    timeWindows: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContractorContractor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Independent detailing contractors';
  ...
  attributes: {
    ...
    completionRate: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
          min: 0;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultAvailability: Schema.Attribute.JSON;
    documents: Schema.Attribute.Media<'images' | 'files', true>;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    homeAddress: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contractor.contractor'
    ...
    performanceTier: Schema.Attribute.Enumeration<
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'End users who book detailing services';
  ...
  attributes: {
    accountCredit: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    bookings: Schema.Attribute.Relation<'oneToMany', 'api::booking.booking'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultAddress: Schema.Attribute.JSON;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiServiceZoneServiceZone extends Struct.CollectionTypeSchema {
  collectionName: 'service_zones';
  info: {
    description: 'Geographic zones where detailing services are available';
    displayName: 'Service Zone';
    pluralName: 'service-zones';
    singularName: 'service-zone';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    contractors: Schema.Attribute.Relation<
      'manyToMany',
      'api::contractor.contractor'
    >;
    coverageRadiusMiles: Schema.Attribute.Decimal &
    ...
    > &
      Schema.Attribute.Private;
    minContractorsRequired: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<2>;
    peakHoursPricing: Schema.Attribute.Decimal &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Detailing service packages (Interior, Exterior, Full)';
    displayName: 'Service';
    pluralName: 'services';
