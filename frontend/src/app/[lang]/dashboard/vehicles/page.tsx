            ...
            <div className="space-y-4">
                ...
                <div className="bg-[var(--card)] p-4 rounded-2xl border border-[var(--divider)] shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-[var(--text-primary)]">Tesla Model 3</h3>
                            <p className="text-sm text-[var(--text-secondary)]">Black • 2023</p>
                        </div>
                    </div>
                    <button className="text-sm font-medium text-[var(--accent)]">Edit</button>
                </div>
