...
export const SERVICES: DetailService[] = [
    {
        ...
        tagline: {
            en: 'Our team comes straight to your door — home or office — no driving, no waiting rooms. Every vehicle gets the same careful attention, whether it is a daily commuter or a weekend favorite. ZERO RISK — inspect first, then authorize the payment.',
            es: 'Nuestro equipo llega directo hasta tu puerta — casa u oficina — sin manejar, sin salas de espera. Cada vehículo recibe la misma atención cuidadosa, ya sea tu auto de todos los días o el de fin de semana. CERO RIESGO — primero revisa, después autorizas el pago.',
        },
        priceFrom: 70,
        durationMin: 120,
        includes: [
    ...
    },
    {
        ...
        tagline: {
            en: 'Our team deep-cleans every surface inside your car — seats, carpets, vents, and dash restored. We pay attention to the details most car washes skip, from cup holders to door jambs. ZERO RISK — inspect first, then authorize the payment.',
            es: 'Nuestro equipo limpia a fondo cada superficie interior — asientos, alfombras, rejillas y tablero restaurados. Cuidamos los detalles que la mayoría de los lavados se saltan, desde portavasos hasta marcos de puertas. CERO RIESGO — primero revisa, después autorizas el pago.',
        },
        priceFrom: 200,
        durationMin: 180,
        includes: [
    ...
    },
    {
        ...
        tagline: {
            en: 'A thorough exterior restoration that goes beyond a standard car wash — foam pre-wash, a safe two-bucket hand wash, clay bar decontamination, and a wax sealant for a deep, glossy shine that lasts. This is the kind of finish that turns heads in the driveway. ZERO RISK — inspect first, then authorize the payment.',
            es: 'Una restauración exterior completa que va más allá de un lavado estándar — espuma antes del lavado, lavado a mano con el método de dos cubetas, descontaminación con clay bar, y cera selladora para un brillo profundo y duradero. Es el tipo de acabado que se nota desde la entrada de tu casa. CERO RIESGO — primero revisa, después autorizas el pago.',
        },
        priceFrom: 200,
        durationMin: 180,
        includes: [
    ...
    },
    {
        ...
        tagline: {
            en: 'Years of protection and a mirror finish — hydrophobic, UV-resistant, gloss-locked. Rain beads off, dirt slides away, and your paint stays protected against the Miami sun and salt air.',
            es: 'Años de protección y acabado espejo — hidrofóbico, resistente a UV, brillo sellado. La lluvia resbala, la suciedad no se pega, y tu pintura queda protegida contra el sol y el aire salado de Miami.',
        },
        priceFrom: 999,
        durationMin: 1440,
        includes: [
        ...
        priority: 0.8,
        icon: '🛡️',
        imageUrl: '/images/services/ceramic-coating-01.jpg',
        imageUrls: [
            '/images/services/ceramic-coating-01.jpg',
            '/images/services/ceramic-coating-02.jpg',
            '/images/services/ceramic-coating-03.jpg',
            '/images/services/ceramic-coating-04.jpg',
            '/images/services/ceramic-coating-05.jpg',
            '/images/services/ceramic-coating-06.jpg',
            '/images/services/ceramic-coating-07.jpg',
            '/images/services/ceramic-coating-08.jpg',
            '/images/services/ceramic-coating-09.jpg',
            '/images/services/ceramic-coating-10.jpg',
            '/images/services/ceramic-coating-11.jpg',
            '/images/services/ceramic-coating-12.jpg',
        ],
    },
    {
        id: 'express-detail',
