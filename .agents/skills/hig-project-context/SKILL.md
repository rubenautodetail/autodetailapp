...
Create and maintain `.Codex/apple-design-context.md` so other HIG skills can skip redundant questions.
...
Generate `.Codex/apple-design-context.md` using this structure:
...
1. Read the current `.Codex/apple-design-context.md`
