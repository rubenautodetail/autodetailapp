...
1. `.Codex/skills/*/` (skills registradas no Codex)
...
| registered     | Se esta em .Codex/skills/ (true/false)            |
...
Opcionalmente, para discovery nativo do Codex:
4. Copiar o SKILL.md para `.Codex/skills/<nome>/SKILL.md`
