...
Remove de `skills/`, `.Codex/skills/`, atualiza o registry e remove ZIP do Desktop.
...
Re-registra TODAS as skills em `.Codex/skills/`, re-empacota todos os ZIPs,
...
7. **Registrar no Codex CLI** - copia SKILL.md para .Codex/skills/<nome>/
...
10. **Empacotar ZIP** - cria ZIP para upload no Codex.ai web/desktop (validado)
11. **Logar operacao** - append em install_log.json (com rotacao automatica)

**IMPORTANTE**: Skills no Codex (CLI) e Codex.ai (web/desktop) sao SEPARADAS.
