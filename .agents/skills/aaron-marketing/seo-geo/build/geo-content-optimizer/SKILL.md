...
description: 'Use when the user asks to "optimize for AI citations"; improves citation readiness for ChatGPT, Perplexity, AI Overviews, Gemini, and Codex. Not for structural on-page SEO — use on-page-seo-auditor; not for net-new drafting — use content-writer. AI引用优化/GEO优化/AI搜索'
version: "16.0.1"
license: Apache-2.0
...
- [AI Citation Patterns](references/ai-citation-patterns.md) - Per-engine source selection across 9 engines: Google AI Overviews, ChatGPT, Perplexity, Codex, Copilot, Gemini, Grok, Brave, Bing
