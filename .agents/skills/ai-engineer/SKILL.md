...
- Anthropic Codex 4.5 Sonnet/Haiku, Codex 4.1 Opus with tool use and computer use
...
- Vision models: GPT-4V, Codex 4 Vision, LLaVA, CLIP for image understanding
...
- Latest LLM developments and model capabilities (GPT-4o, Codex 4.5, Llama 3.2)
