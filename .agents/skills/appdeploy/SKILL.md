...
**Parameters:**
  ...
  - `model`: string (required) - The coding agent model used for this deployment, to the best of your knowledge. Examples: 'codex-5.3', 'chatgpt', 'opus 4.6', 'Codex-sonnet-4-5', 'gemini-2.5-pro'
